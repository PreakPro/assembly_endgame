...
export default function InfoThing(props: MainProps) {
    return (
		<section className={cn(" justify-center text-center items-center z-50", props.containerClassName)}>
			...
			{props.isInfoOpen && (	
				<div>
					<button onClick={props.isInfoOpenToggle} className="relative transition-all text-white light:text-black rounded-lg text-3xl font-bold hover:opacity-60 bg-blue-500 p-6 w-60 z-50 mb-50 md:mb-15 shadow-md border-2 border-black shadow-black">GOT IT!</button>
					<motion.div 
